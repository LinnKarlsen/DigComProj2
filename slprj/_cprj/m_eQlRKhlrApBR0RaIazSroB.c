...
static void cgxe_mdl_start(InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_eQlRKhlrApBR0RaIazSroB
...
static void mw__internal__call__reset(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance, const emlrtStack *sp, real_T CustomPhaseOffset, real_T
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance, const emlrtStack *sp, real_T CustomPhaseOffset, real_T
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth,
  creal_T b_u0[1000], creal_T c_y0[1000], real_T c_y1[1000]);
static void mw__internal__system___fcn(InstanceStruct_eQlRKhlrApBR0RaIazSroB
...
static const mxArray *emlrt_marshallOut(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_eQlRKhlrApBR0RaIazSroB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_eQlRKhlrApBR0RaIazSroB
...
static void carrierSyncCore(creal_T input[1000], real_T *loopFiltState, real_T
  ...
  *proportionalGain, real_T *phaseOffset, creal_T output[1000], real_T
  phaseEstimate[1000]);
static void init_simulink_io_address(InstanceStruct_eQlRKhlrApBR0RaIazSroB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_eQlRKhlrApBR0RaIazSroB(SimStruct *S, int_T tid)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_eQlRKhlrApBR0RaIazSroB(SimStruct *S, int_T tid)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_eQlRKhlrApBR0RaIazSroB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
  InstanceStruct_eQlRKhlrApBR0RaIazSroB *moduleInstance =
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB *)calloc(1, sizeof
    (InstanceStruct_eQlRKhlrApBR0RaIazSroB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_eQlRKhlrApBR0RaIazSroB);
  ssSetmdlInitializeConditions(S, mdlInitialize_eQlRKhlrApBR0RaIazSroB);
  ssSetmdlUpdate(S, mdlUpdate_eQlRKhlrApBR0RaIazSroB);
  ssSetmdlDerivatives(S, mdlDerivatives_eQlRKhlrApBR0RaIazSroB);
  ssSetmdlTerminate(S, mdlTerminate_eQlRKhlrApBR0RaIazSroB);
  ssSetmdlEnable(S, mdlEnable_eQlRKhlrApBR0RaIazSroB);
  ssSetmdlDisable(S, mdlDisable_eQlRKhlrApBR0RaIazSroB);
...
static void mdlProcessParameters_eQlRKhlrApBR0RaIazSroB(SimStruct *S)
{
}

void method_dispatcher_eQlRKhlrApBR0RaIazSroB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_eQlRKhlrApBR0RaIazSroB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_eQlRKhlrApBR0RaIazSroB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_eQlRKhlrApBR0RaIazSroB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_eQlRKhlrApBR0RaIazSroB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: eQlRKhlrApBR0RaIazSroB.\n"
...
mxArray *cgxe_eQlRKhlrApBR0RaIazSroB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_eQlRKhlrApBR0RaIazSroB_fallback_info(void)
{
