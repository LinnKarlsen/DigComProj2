...
#include "m_rDBZlbWqKaW5iBhJ7I3mOD.h"
...
static emlrtRSInfo o_emlrtRSI = { 236, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};

static emlrtRSInfo p_emlrtRSI = { 215, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};

static emlrtRSInfo q_emlrtRSI = { 222, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};

static emlrtRSInfo r_emlrtRSI = { 302, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};
...
static emlrtRSInfo w_emlrtRSI = { 68,  /* lineNo */
  "",                                  /* fcnName */
  ""                                   /* pathName */
};
...
static emlrtRSInfo y_emlrtRSI = { 412, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};

static emlrtRSInfo ab_emlrtRSI = { 334,/* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};
...
static emlrtRSInfo fb_emlrtRSI = { 3,  /* lineNo */
  "",                                  /* fcnName */
  ""                                   /* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance, const emlrtStack *sp, real_T CustomPhaseOffset, real_T
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth);
static void SystemProp_matlabCodegenSetAnyProp(comm_CarrierSynchronizer *obj);
static void CarrierSynchronizer_set_CustomPhaseOffset(const emlrtStack *sp,
...
static void mw__internal__call__reset(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance, const emlrtStack *sp, real_T CustomPhaseOffset, real_T
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance, const emlrtStack *sp, real_T CustomPhaseOffset, real_T
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth,
  creal_T b_u0[1000], creal_T c_y0[1000], real_T c_y1[1000]);
static void mw__internal__system___fcn(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance, const emlrtStack *sp, real_T varargin_3, real_T varargin_4,
  real_T varargin_5, real_T varargin_6, creal_T varargin_8[1000], creal_T
  varargout_1[1000], real_T varargout_2[1000]);
static void SystemCore_step(const emlrtStack *sp, comm_CarrierSynchronizer *obj,
  creal_T varargin_1[1000], creal_T varargout_1[1000], real_T varargout_2[1000]);
static void SystemCore_setupAndReset(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static boolean_T SystemCore_detectInputSizeChange(comm_CarrierSynchronizer *obj);
static void CarrierSynchronizer_stepImpl(comm_CarrierSynchronizer *obj, creal_T
  input[1000], creal_T output[1000], real_T phaseEstimate[1000]);
static creal_T expFunc(real_T in, boolean_T isSingle);
static const mxArray *emlrt_marshallOut(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
...
static void cgxe_mdl_set_sim_state(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
...
static creal_T q_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void carrierSyncCore(creal_T input[1000], real_T *loopFiltState, real_T
  *integFiltState, real_T *DDSPreviousInp, creal_T *previousSample, real_T
  *phase, real_T *digitalSynthesizerGain, real_T *integratorGain, real_T
  *proportionalGain, real_T *phaseOffset, creal_T output[1000], real_T
  phaseEstimate[1000]);
static void init_simulink_io_address(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD
  *moduleInstance);
...
static void cgxe_mdl_start(InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance)
{
  ...
  NormalizedLoopBandwidth = (real_T *)cgxertGetRunTimeParamInfoData
    (moduleInstance->S, 3);
  DampingFactor = (real_T *)cgxertGetRunTimeParamInfoData(moduleInstance->S, 2);
  SamplesPerSymbol = (real_T *)cgxertGetRunTimeParamInfoData(moduleInstance->S,
    1);
  CustomPhaseOffset = (real_T *)cgxertGetRunTimeParamInfoData(moduleInstance->S,
    0);
  st.tls = moduleInstance->emlrtRootTLSGlobal;
  cgxertSetGcb(moduleInstance->S, -1, -1);
  mw__internal__call__setup(moduleInstance, &st, *CustomPhaseOffset,
  ...
  *moduleInstance)
{
  ...
  cgxertSetGcb(moduleInstance->S, -1, -1);
  mw__internal__call__reset(moduleInstance, &st, *CustomPhaseOffset,
    *SamplesPerSymbol, *DampingFactor, *NormalizedLoopBandwidth);
  cgxertRestoreGcb(moduleInstance->S, -1, -1);
}
  ...
  *moduleInstance)
{
  ...
  st.tls = moduleInstance->emlrtRootTLSGlobal;
  cgxertSetGcb(moduleInstance->S, -1, -1);
  mw__internal__call__step(moduleInstance, &st, *CustomPhaseOffset,
    *SamplesPerSymbol, *DampingFactor, *NormalizedLoopBandwidth,
    *moduleInstance->u0, *moduleInstance->b_y0, *moduleInstance->b_y1);
  cgxertRestoreGcb(moduleInstance->S, -1, -1);
}
  ...
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 1000, 1, 1, 1, 1, 1, 1, 1 };
  ...
  static char_T correctedValue[6] = { 'C', 'u', 's', 't', 'o', 'm' };
  ...
  if (!moduleInstance->sysobj_not_empty) {
    ...
    st.site = &h_emlrtRSI;
    CarrierSynchronizer_set_CustomPhaseOffset(&st, &moduleInstance->sysobj,
      CustomPhaseOffset);
    st.site = &i_emlrtRSI;
    b_st.site = &d_emlrtRSI;
    if (moduleInstance->sysobj.isInitialized == 1) {
  ...
  comm_CarrierSynchronizer *obj, real_T b_value)
{
  ...
  static char_T d_u[21] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'e', 'x', 'p',
    'e', 'c', 't', 'e', 'd', 'N', 'o', 'n', 'N', 'a', 'N' };

  static char_T h_u[17] = { 'C', 'u', 's', 't', 'o', 'm', 'P', 'h', 'a', 's',
    'e', 'O', 'f', 'f', 's', 'e', 't' };
  ...
  comm_CarrierSynchronizer *obj, real_T b_value)
{
  ...
  if (!p) {
    ...
    error(&c_st, y, getString(&c_st, message(&c_st, c_y, f_y, &c_emlrtMCI),
  ...
  if (!p) {
    ...
    emlrtAssign(&i_y, m);
    c_st.site = &hb_emlrtRSI;
    error(&c_st, b_y, getString(&c_st, message(&c_st, e_y, i_y, &emlrtMCI),
           &emlrtMCI), &emlrtMCI);
  }
  ...
  if (!p) {
    ...
    emlrtAssign(&k_y, m);
    c_st.site = &gb_emlrtRSI;
    error(&c_st, d_y, getString(&c_st, message(&c_st, h_y, k_y, &b_emlrtMCI),
           &b_emlrtMCI), &b_emlrtMCI);
  }
  ...
  comm_CarrierSynchronizer *obj, real_T b_value)
{
  ...
  if (!p) {
    ...
    emlrtAssign(&n_y, m);
    c_st.site = &ib_emlrtRSI;
    error(&c_st, d_y, getString(&c_st, message(&c_st, i_y, n_y, &c_emlrtMCI),
           &c_emlrtMCI), &c_emlrtMCI);
  }
  ...
  if (!p) {
    ...
    emlrtAssign(&r_y, m);
    c_st.site = &hb_emlrtRSI;
    error(&c_st, g_y, getString(&c_st, message(&c_st, m_y, r_y, &emlrtMCI),
           &emlrtMCI), &emlrtMCI);
  }
  ...
  if (!p) {
    ...
    emlrtAssign(&s_y, m);
    c_st.site = &gb_emlrtRSI;
    error(&c_st, l_y, getString(&c_st, message(&c_st, p_y, s_y, &b_emlrtMCI),
           &b_emlrtMCI), &b_emlrtMCI);
  }
  ...
  creal_T b_u0[1000], creal_T c_y0[1000], real_T c_y1[1000])
{
  ...
  st.tls = sp->tls;
  st.site = &fb_emlrtRSI;
  mw__internal__system___fcn(moduleInstance, &st, CustomPhaseOffset,
    SamplesPerSymbol, DampingFactor, NormalizedLoopBandwidth, b_u0, c_y0, c_y1);
}
  ...
  varargout_1[1000], real_T varargout_2[1000])
{
  ...
  if (moduleInstance->sysobj.CustomPhaseOffset != varargin_3) {
    st.site = &t_emlrtRSI;
    b_st.site = &d_emlrtRSI;
    if (moduleInstance->sysobj.isInitialized == 1) {
      moduleInstance->sysobj.TunablePropsChanged = true;
  ...
  if (moduleInstance->sysobj.SamplesPerSymbol != varargin_4) {
    st.site = &u_emlrtRSI;
    b_st.site = &d_emlrtRSI;
    if (moduleInstance->sysobj.isInitialized == 1) {
      moduleInstance->sysobj.TunablePropsChanged = true;
  ...
  if (moduleInstance->sysobj.DampingFactor != varargin_5) {
    st.site = &v_emlrtRSI;
    b_st.site = &d_emlrtRSI;
    if (moduleInstance->sysobj.isInitialized == 1) {
      moduleInstance->sysobj.TunablePropsChanged = true;
  ...
  if (moduleInstance->sysobj.NormalizedLoopBandwidth != varargin_6) {
    st.site = &w_emlrtRSI;
    b_st.site = &d_emlrtRSI;
    if (moduleInstance->sysobj.isInitialized == 1) {
      moduleInstance->sysobj.TunablePropsChanged = true;
  ...
  st.site = &x_emlrtRSI;
  SystemCore_step(&st, &moduleInstance->sysobj, varargin_8, varargout_1,
                  varargout_2);
}
  ...
  creal_T varargin_1[1000], creal_T varargout_1[1000], real_T varargout_2[1000])
{
  ...
  st.site = &e_emlrtRSI;
  SystemCore_detectInputSizeChange(obj);
  st.site = &e_emlrtRSI;
  CarrierSynchronizer_stepImpl(obj, varargin_1, varargout_1, varargout_2);
  st.site = &e_emlrtRSI;
  ...
  comm_CarrierSynchronizer *obj)
{
  ...
  b_st.site = &e_emlrtRSI;
  CarrierSynchronizer_setupImpl(obj);
  b_st.site = &e_emlrtRSI;
...
static boolean_T SystemCore_detectInputSizeChange(comm_CarrierSynchronizer *obj)
{
  static int16_T inSize[8] = { 1000, 1, 1, 1, 1, 1, 1, 1 };
  ...
  input[1000], creal_T output[1000], real_T phaseEstimate[1000])
{
  ...
  st.site = &ab_emlrtRSI;
  carrierSyncCore(input, &loopFiltState, &integFiltState, &DDSPreviousInp,
  ...
  *moduleInstance, const emlrtStack *sp)
{
  ...
  *(int32_T *)emlrtMxGetData(m) = moduleInstance->sysobj.isInitialized;
  ...
  g_y = NULL;
  m = emlrtCreateCharArray(2, &iv2[0]);
  emlrtInitCharArrayR2013a((emlrtConstCTX)sp, 6, m, &b_u[0]);
  emlrtAssign(&g_y, m);
  ...
  phaseEstimate[1000])
{
  ...
  for (k = 0; k < 1000; k++) {
    ...
    *phase = *digitalSynthesizerGain * DDSOut;
    phaseCorrection[k].re = *phase;
    phaseCorrection[k].im = 0.0;
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[1000])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[1000])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y1 = (real_T (*)[1000])cgxertGetOutputPortSignal
    (moduleInstance->S, 1);
}

/* CGXE Glue Code */
static void mdlOutputs_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S, int_T tid)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S, int_T tid)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static void setSimState_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
  InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *moduleInstance =
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD *)calloc(1, sizeof
    (InstanceStruct_rDBZlbWqKaW5iBhJ7I3mOD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_rDBZlbWqKaW5iBhJ7I3mOD);
  ssSetmdlInitializeConditions(S, mdlInitialize_rDBZlbWqKaW5iBhJ7I3mOD);
  ssSetmdlUpdate(S, mdlUpdate_rDBZlbWqKaW5iBhJ7I3mOD);
  ssSetmdlDerivatives(S, mdlDerivatives_rDBZlbWqKaW5iBhJ7I3mOD);
  ssSetmdlTerminate(S, mdlTerminate_rDBZlbWqKaW5iBhJ7I3mOD);
  ssSetmdlEnable(S, mdlEnable_rDBZlbWqKaW5iBhJ7I3mOD);
  ssSetmdlDisable(S, mdlDisable_rDBZlbWqKaW5iBhJ7I3mOD);
...
static void mdlProcessParameters_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S)
{
}

void method_dispatcher_rDBZlbWqKaW5iBhJ7I3mOD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_rDBZlbWqKaW5iBhJ7I3mOD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_rDBZlbWqKaW5iBhJ7I3mOD(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_rDBZlbWqKaW5iBhJ7I3mOD(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_rDBZlbWqKaW5iBhJ7I3mOD(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: rDBZlbWqKaW5iBhJ7I3mOD.\n"
...
mxArray *cgxe_rDBZlbWqKaW5iBhJ7I3mOD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
  ...
  elem_6 = mxCreateString("math.h");
  mxSetCell(elem_5,0,elem_6);
  elem_7 = mxCreateString("signLib.h");
  ...
  elem_18 = mxCreateCellMatrix(1,1);
  elem_19 = mxCreateString("comm.internal.utilities.mathCore");
  mxSetCell(elem_18,0,elem_19);
  mxSetCell(mxBIArgs,1,elem_18);
  elem_20 = mxCreateCellMatrix(1,0);
  mxSetCell(mxBIArgs,2,elem_20);
  return mxBIArgs;
}

mxArray *cgxe_rDBZlbWqKaW5iBhJ7I3mOD_fallback_info(void)
{
