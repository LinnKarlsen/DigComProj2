#ifndef __eQlRKhlrApBR0RaIazSroB_h__
#define __eQlRKhlrApBR0RaIazSroB_h__
...
#ifndef struct_tag_bx3YvsOfnnk5SLMkPzivKB
#define struct_tag_bx3YvsOfnnk5SLMkPzivKB

struct tag_bx3YvsOfnnk5SLMkPzivKB
{
  char_T f1[4];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_bx3YvsOfnnk5SLMkPzivKB */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_bx3YvsOfnnk5SLMkPzivKB cell;
...
typedef struct tag_92EVd9XKm6NA2yfmfFtMS b_cell;
...
typedef struct tag_hEVPFOGCYhJIualz6vMiMC c_cell;
...
typedef struct tag_qWXpA84tzIgYkkUCcMt1JF d_cell;
...
#ifndef struct_tag_tTctpaKX3GAQhBE6vTmqQH
#define struct_tag_tTctpaKX3GAQhBE6vTmqQH

struct tag_tTctpaKX3GAQhBE6vTmqQH
{
  cell _data;
};

#endif                                 /* struct_tag_tTctpaKX3GAQhBE6vTmqQH */

#ifndef typedef_s_tTctpaKX3GAQhBE6vTmqQH
#define typedef_s_tTctpaKX3GAQhBE6vTmqQH

typedef struct tag_tTctpaKX3GAQhBE6vTmqQH s_tTctpaKX3GAQhBE6vTmqQH;

#endif                                 /* typedef_s_tTctpaKX3GAQhBE6vTmqQH */
...
#ifndef struct_tag_esXkUvvocA7QuJuiNbKRdC
#define struct_tag_esXkUvvocA7QuJuiNbKRdC

struct tag_esXkUvvocA7QuJuiNbKRdC
{
  int32_T isInitialized;
  boolean_T TunablePropsChanged;
  cell_wrap inputVarSize[1];
  char_T ModulationPhaseOffset[6];
...
#endif                                 /* struct_tag_esXkUvvocA7QuJuiNbKRdC */

#ifndef typedef_comm_CarrierSynchronizer
#define typedef_comm_CarrierSynchronizer

typedef struct tag_esXkUvvocA7QuJuiNbKRdC comm_CarrierSynchronizer;

#endif                                 /* typedef_comm_CarrierSynchronizer */

#ifndef typedef_InstanceStruct_eQlRKhlrApBR0RaIazSroB
#define typedef_InstanceStruct_eQlRKhlrApBR0RaIazSroB
...
#endif                                 /* typedef_InstanceStruct_eQlRKhlrApBR0RaIazSroB */
...
extern void method_dispatcher_eQlRKhlrApBR0RaIazSroB(SimStruct *S, int_T method,
  void* data);
